    ...
    private final Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (!complete) {
                ...
                if (avg[0] < 150) {
                    Toast.makeText(MainActivity.this, "Your finger is misplaced!", Toast.LENGTH_SHORT).show();
                    startTime = System.currentTimeMillis();
                    inc=0;
                    progress.setProgress(0);
                }
                ...
                if (totalTimeInSecs >= 15) {
                    ...
                    String url = "https://dabedon405.pythonanywhere.com/";
                        ...
                        JsonObjectRequest request = new JsonObjectRequest(
                                ...
                                new Response.Listener<JSONObject>() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        try {
                                            ...
                                            int user_id = new SessionManager(MainActivity.this).getUserId();
                                            String currentTime = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new java.util.Date());
                                            dbHelper.addSpo2((int) response.getDouble("spo2"), user_id, currentTime);
                                ...
                                new Response.ErrorListener() {
                                    ...
                                    public void onErrorResponse(VolleyError error) {
                                        s.require(MainActivity.this, "spo2");
